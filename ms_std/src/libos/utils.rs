...
pub macro func_type {
    ...
    (heap_alloc) => (ms_hostcall::mm::HeapAllocFunc),
    (heap_dealloc) => (ms_hostcall::mm::HeapDeallocFunc),
...
pub macro hostcall_id {
    ...
    (heap_alloc) => (ms_hostcall::CommonHostCall::HeapAlloc),
    (heap_dealloc) => (ms_hostcall::CommonHostCall::HeapDealloc),
