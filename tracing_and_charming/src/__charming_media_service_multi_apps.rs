...
use charming::{
    ...
    element::{
        AxisPointer, AxisPointerType, AxisType, Color, SplitArea, SplitLine, Tooltip, Trigger,
    },
    series::Boxplot,
    Chart, ImageRenderer,
};
...
pub fn chart() -> Chart {
    ...
    Chart::new()
        ...
        .background_color(Color::Value("white".to_owned()))
        .dataset(
            Dataset::new()
                .source(data0)
                .source(data1)
        ...
        .series(Boxplot::new().name("category0").dataset_index(2))
        .series(Boxplot::new().name("category1").dataset_index(3))
}
