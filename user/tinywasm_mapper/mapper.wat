(module $mapper.wasm
  ...
  (func $__original_main (type 10) (result i32)
    ...
    local.get 2
    local.get 4
    i32.store offset=64296
    i32.const 3
    local.set 5
    local.get 2
    local.get 5
    i32.store offset=64292
    i32.const 64256
    local.set 6
    local.get 2
    local.get 6
  ...
  (table (;0;) 7 7 funcref)
  (memory (;0;) 2)
  (global $__stack_pointer (mut i32) (i32.const 71472))
