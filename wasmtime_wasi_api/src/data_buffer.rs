...
pub fn buffer_register(
    ...
    #[cfg(feature = "log")]
    println!("buffer_register: slot_name={}", slot_name);

    let buffer_base = memory.data_mut(&mut caller)
                                    .get_mut(buffer_base as usize..)
...
pub fn access_buffer(
    ...
    #[cfg(feature = "log")]
    println!("access_buffer: slot_name={}", slot_name);
