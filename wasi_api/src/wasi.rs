...
pub fn clock_time_get(mut ctx: FuncContext, args: (i32, i64, i32)) -> tinywasm::Result<i32> {
    ...
    mem.store(time_ptr, core::mem::size_of::<u128>(), &time_var.to_ne_bytes())?;

    Ok(0)
}

pub fn environ_get(_: FuncContext<'_>, args: (i32, i32)) -> tinywasm::Result<i32> {
    #[cfg(feature="log")] {
...
pub fn environ_sizes_get(mut ctx: FuncContext, args: (i32, i32)) -> tinywasm::Result<i32> {
    #[cfg(feature="log")] {
        ...
        println!("args: environ_count: {:?}, environ_buf_size: {:?}", args.0, args.1);
    }

    let count_ptr = args.0 as usize;
    let buf_size_ptr = args.1 as usize;
    let count = 0 as i32;
    let buf_size = 0 as i32;
    let mut mem = ctx.exported_memory_mut("memory")?;
    mem.store(count_ptr, core::mem::size_of::<i32>(), &count.to_ne_bytes())?;
    mem.store(buf_size_ptr, core::mem::size_of::<i32>(), &buf_size.to_ne_bytes())?;
...
pub fn fd_filestat_get(_: FuncContext<'_>, args: (i32, i32)) -> tinywasm::Result<i32> {
    #[cfg(feature="log")] {
...
pub fn fd_filestat_set_size(_: FuncContext<'_>, args: (i32, i64)) -> tinywasm::Result<i32> {
    #[cfg(feature="log")] {
...
pub fn fd_readdir(mut ctx: FuncContext<'_>, args: (i32, i32, i32, i64, i32)) -> tinywasm::Result<i32> {
    #[cfg(feature="log")] {
        ...
        println!("args: fd: {:?}, buf: {:?}, buf_len: {:?}, cookie: {:?}, bufused: {:?}", args.0, args.1, args.2, args.3, args.4);
    }
...
pub fn fd_sync(_: FuncContext<'_>, args: i32) -> tinywasm::Result<i32> {
    #[cfg(feature="log")] {
...
pub fn path_create_directory(mut ctx: FuncContext<'_>, args: (i32, i32, i32)) -> tinywasm::Result<i32> {
    #[cfg(feature="log")] {
        println!("[Debug] Invoke into path_create_directory");
        println!("args: fd: {:?}, path: {:?}, path_len: {:?}", args.0, args.1, args.2);
    }
 
    Ok(0)
}

pub fn path_filestat_get(mut ctx: FuncContext<'_>, args: (i32, i32, i32, i32, i32)) -> tinywasm::Result<i32> {
    #[cfg(feature="log")] {
        println!("[Debug] Invoke into path_filestat_get");
        println!("args: fd: {:?}, flags: {:?}, path: {:?}, path_len: {:?}, buf: {:?}", args.0, args.1, args.2, args.3, args.4);
    }

    Ok(0)
}

pub fn path_filestat_set_times(_: FuncContext<'_>, args: (i32, i32, i32, i32, i64, i64, i32)) -> tinywasm::Result<i32> {
    #[cfg(feature="log")] {
...
pub fn path_readlink(mut ctx: FuncContext<'_>, args: (i32, i32, i32, i32, i32, i32)) -> tinywasm::Result<i32> {
    #[cfg(feature="log")] {
...
pub fn path_remove_directory(mut ctx: FuncContext<'_>, args: (i32, i32, i32)) -> tinywasm::Result<i32> {
    #[cfg(feature="log")] {
...
pub fn path_unlink_file(mut ctx: FuncContext<'_>, args: (i32, i32, i32)) -> tinywasm::Result<i32> {
    #[cfg(feature="log")] {
...
pub fn poll_oneoff(mut ctx: FuncContext<'_>, args: (i32, i32, i32, i32)) -> tinywasm::Result<i32> {
    #[cfg(feature="log")] {
        println!("[Debug] Invoke into poll_oneoff");
        println!("args: in_: {:?}, out_: {:?}, nsubscriptions: {:?}, nevents: {:?}", args.0, args.1, args.2, args.3);
    }
...
pub fn sched_yield(mut ctx: FuncContext<'_>, args: ()) -> tinywasm::Result<i32> {
    #[cfg(feature="log")] {
